...
export default new (class Waitlist {
        ...
        if (profile.canAutoplay && !profile.autoplay) {
            ...
            this.autojoinTimer = setInterval(() => {
                ...
                if (epoch() - profile.lastchat >= 3600) {
                    ...
                    let msg = "You were removed from the waitlist because it's been one hour since your last chat.";
    ...
    @computed get bigButtonLoading() {
        return this.localJoinState !== this.inWaitlist || this.localPlayingState !== this.isPlaying;
    }
