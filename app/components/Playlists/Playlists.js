  ...
  render: function() {
    ...
    return (
      <div id="playlists-component">
        <PlaylistsPanel playlistsOpen={this.props.playlistsOpen} searchForVideo={this.props.searchForVideo} playlistsPanelView={this.props.playlistsPanelView} currentSearch={this.props.currentSearch} addNewPlaylist={this.props.addNewPlaylist} currentPlaylist={this.props.currentPlaylist} playlists={this.props.playlists} removePlaylist={this.props.removePlaylist} selectPlaylist={this.props.selectPlaylist} addToPlaylist={this.props.addToPlaylist} removeFromPlaylist={this.props.removeFromPlaylist} moveTopPlaylist={this.props.moveTopPlaylist} shufflePlaylist={this.props.shufflePlaylist} playlistImport={this.props.playlistImport}/>
        <div id="playlists-bar" className="row">
          ...
          <div id="grabtrack" className="col-lg-1 col-md-1 col-sm-1 col-xs-1">
            {grabPlaylistsDiv}
            <div className="grab-button" onClick={this.handleGrabButton}>
              <i className={grabClass}></i>
              <span className="feedback-grab">{this.props.playingMedia.feedback.grabs}</span>
            </div>
            <div className="volume-slider" ref="volslider">
              <i className={volClass}></i>
              <ReactSlider max={1} step={0.01} defaultValue={0} value={this.props.controls.volume} className="volume-slider-node" handleClassName="volume-slider-handle" handleActiveClassName="volume-slider-handle-active" barClassName="volume-slider-bar" onChange={this.updateVolume} withBars={true}/>

            </div>

          </div>
          <div id="vote" className="col-lg-1 col-md-1 col-sm-1 col-xs-1">
            <div className="like-button" onClick={this.props.handleLikeButton}>
              <i className={likeClass}></i>
              <span className="feedback-likes">{this.props.playingMedia.feedback.likes}</span>
            </div>
            <div className="dislike-button" onClick={this.props.handleDislikeButton}>
              <i className={dislikeClass}></i>
              <span className="feedback-dislikes">{this.props.playingMedia.feedback.dislikes}</span>
            </div>
          </div>
